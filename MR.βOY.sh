#pliss jangan di recoodt nanti MRBOY
#nya marah salam nama asli me dinata
#kalo mrβoy marah nanti siapa yg bantu kamu nge hack
clear
b="\033[1m"
u="\033[4m"
bl="\033[30m"
...
figlet *kami B490NG_TIM siap membuat anda jadi mastahnuub* |lolcat
...
Trying To Exit ... "
echo  $cyan"[#]> Subscribe chanel masternuub"
sleep 1
echo ""
...
mv Dedos-attack $HOME
cd $HOME/Dedos-attack
chmod +x dedeos.py
python2 dedeos.py
...
pkg install python2 -y
pip2 install requests
git clone https://github.com/LOoLzeC/kontol
mv kontol $HOME
cd $HOME/kontol
chmod +x kontol.py
python2 kontol.py
...
echo ""
echo "Cara Cek, ketik : whoami" |lolcat
...
00) clear
echo "created by : <==B490NG_TIM==>" |lolcat
echo "Saya Ganteng tau" |lolcat
figlet *Cuma Gaada Yg Tau |lolcat
echo "jangan lupa subscibe" |lolcat
figlet *MASTERNUUB* |lolcat
figlet *Asalamualaikum* |lolcat
echo "Walaikumsalam" |lolcat
exit

;;

*) echo  $g "WARNING!!!,
Maaf teryata anda sangat nuub
Tidak ada pilihan itu jancok dasar tolol
mening hapus ajah akun main pow ajh!"
esac
done
done
